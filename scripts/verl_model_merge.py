...
def main():
    ...
    base_op_parser.add_argument("--hf_model_config_path", type=str, required=False, default=None)
    ...
    common_config_args = {
        ...
        "hf_model_config_path": args.local_dir if not args.hf_model_config_path else args.hf_model_config_path,
    }
